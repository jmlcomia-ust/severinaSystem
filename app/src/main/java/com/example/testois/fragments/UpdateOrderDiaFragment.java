...
public class UpdateOrderDiaFragment extends DialogFragment {
    ...
    public interface OnInputListener {
        //void UpdateInput(String id, String name, String qty, String stat, byte[] bytesImage);
        void UpdateInput(String id, String name, String qty, String stat);
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        btn_add_vord.setOnClickListener(v ->{
            ...
            fragupdate.UpdateInput(id,name_updated, qty_updated, stat_updated);
            getDialog().dismiss();
